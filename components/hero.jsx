	...
	return (
		<section className="relative overflow-hidden py-24 md:py-32 lg:py-40">
			<div className="container flex flex-col items-center">
				<h1 className="animate-gradient font-display bg-gradient-to-r from-primary via-accent to-primary bg-clip-text text-4xl font-bold tracking-wider text-transparent sm:text-5xl md:text-6xl lg:text-9xl">
					Hi, <br />
					I'm Aditya
				</h1>
